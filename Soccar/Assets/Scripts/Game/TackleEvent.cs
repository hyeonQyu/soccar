...
public class TackleEvent : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        {
            if(_animator.GetCurrentAnimatorStateInfo(0).nameHash == Animator.StringToHash("Base Layer.Tackle") && LayerMask.LayerToName(other.gameObject.layer).Equals("RagDoll"))
            {
